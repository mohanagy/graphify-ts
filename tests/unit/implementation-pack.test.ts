    ...
    [
      {
        ...
        nodes: [
          ...
          { id: 'users_service_file', label: 'service.ts', file_type: 'code', source_file: `${root}/src/users/service.ts`, source_location: 'L1', node_kind: 'module', community: 1 },
          ...
          { id: 'users_prisma', label: 'prisma.user.findFirst', file_type: 'code', source_file: `${root}/src/users/repository.ts`, source_location: 'L21', node_kind: 'call_expression', community: 2 },
        ],
        edges: [
